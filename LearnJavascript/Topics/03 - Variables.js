...
describe('Variables', function () {
  ...
  it('you can assign strings to var', function () {
    let variable = "ValueToBeAssigned";
  ...
  it('you can change the value of a variable', function () {
    let variable = 5; //This allocates memory for var 'variable'
  ...
  it('You can compare string lengths using the length property', function () {
    let stringVariable = "This is a string variable";
    let stringVariableTwo = "This is a second string variable";
